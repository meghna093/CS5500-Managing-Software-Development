...
class SumUpTestCases {
	...
	/**
	 * Calculates sum from 0 to -1
	 * Sum of 0 to -1 should throw an exception
	 * The same is tested below 
	 */
	@Test
	public void testSumUp5() {
		int num1 = -1;
		assertThrows(Exception.class, () -> {inst.sumUp(num1);});
	}
	
	/**
	 * Calculates sum from 0 to 65534
	 * Sum of 0 to 65534 should return 2147385345
	 * The same is tested below 
	 */
	@Test
	public void testSumUp6() {
		int num1 = 65534;
		assertEquals(2147385345, inst.sumUp(num1));
	}
	
	/**
	 * Calculates sum from 0 to -65534
	 * Sum of 0 to -65534 should throw an exception
	 * The same is tested below 
	 */
	@Test
	public void testSumUp7() {
		int num1 = -65534;
		assertThrows(Exception.class, () -> {inst.sumUp(num1);});
	}
}
