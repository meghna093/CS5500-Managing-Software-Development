...
class SqrTestCases {
	...
	/**
	 * Calculates the square of 46340
	 * Square of 46340 should return 2147395600
	 * The same is tested below
	 */
	@Test
	public void testSqr7() {
		int num1 = 46340;
		assertEquals(2147395600, inst.sqr(num1));
	}
	 ...
	 */
	@Test
	public void testSqr8() {
		int num1 = -46340;
		assertEquals(2147395600, inst.sqr(num1));
	}
	
	/**
	 * Calculates the square of -46341
	 * Square of -46341 should throw an exception
	 * The same is tested below
	 */
	@Test
	public void testSqr9() {
		int num1 = -46341;
		assertThrows(Exception.class, () -> {inst.sqr(num1);});
	}
